...
#ifndef __XL362_REG_H
#define __XL362_REG_H
...
/* Bit value in FIFO_DATA                                                */
#define XL362_FIFO_DATA_AXIS_MASK       (3 << 14)
#define XL362_FIFO_DATA_AXIS_X          (0 << 14)
#define XL362_FIFO_DATA_AXIS_Y          (1 << 14)
#define XL362_FIFO_DATA_AXIS_Z          (2 << 14)

/* Wartermark */
#define ACC_FIFO_WATERMARK      125

#endif /* __XL362__REG_H */
